...
export const AppShell: FC<AppShellProps> = ({children, logo, toolbar, sidebar, sidebarOpen, footer}) => {
  return (
    <section className="flex flex-col items-stretch min-h-screen text-neutral-500">
      { toolbar || logo ? <nav className="h-16 flex items-center bg-white text-sm border-b">
