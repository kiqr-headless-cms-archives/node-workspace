...
export const ResourcesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createResource: async (projectId: string, createResourceRequest?: CreateResourceRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
            assertParamExists('createResource', 'projectId', projectId)
            const localVarPath = `/projects/{project_id}/resources`
         ...
         * @throws {RequiredError}
         */
        getResource: async (id: string, projectId: string, environmentId: string, contentType: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getResource', 'id', id)
            // verify required parameter 'projectId' is not null or undefined
            assertParamExists('getResource', 'projectId', projectId)
            // verify required parameter 'environmentId' is not null or undefined
            assertParamExists('getResource', 'environmentId', environmentId)
            // verify required parameter 'contentType' is not null or undefined
            assertParamExists('getResource', 'contentType', contentType)
            const localVarPath = `/projects/{project_id}/resources/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)))
                .replace(`{${"project_id"}}`, encodeURIComponent(String(projectId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        getResources: async (projectId: string, environmentId: string, contentType: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
            assertParamExists('getResources', 'projectId', projectId)
            // verify required parameter 'environmentId' is not null or undefined
            assertParamExists('getResources', 'environmentId', environmentId)
            // verify required parameter 'contentType' is not null or undefined
            assertParamExists('getResources', 'contentType', contentType)
            const localVarPath = `/projects/{project_id}/resources`
                .replace(`{${"project_id"}}`, encodeURIComponent(String(projectId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const ResourcesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createResource(projectId: string, createResourceRequest?: CreateResourceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Resource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createResource(projectId, createResourceRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getResource(id: string, projectId: string, environmentId: string, contentType: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Resource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getResource(id, projectId, environmentId, contentType, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getResources(projectId: string, environmentId: string, contentType: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Resource>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getResources(projectId, environmentId, contentType, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ResourcesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createResource(projectId: string, createResourceRequest?: CreateResourceRequest, options?: any): AxiosPromise<Resource> {
            return localVarFp.createResource(projectId, createResourceRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get a resources
         ...
         * @throws {RequiredError}
         */
        getResource(id: string, projectId: string, environmentId: string, contentType: string, options?: any): AxiosPromise<Resource> {
            return localVarFp.getResource(id, projectId, environmentId, contentType, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List resources
         ...
         * @throws {RequiredError}
         */
        getResources(projectId: string, environmentId: string, contentType: string, options?: any): AxiosPromise<Array<Resource>> {
            return localVarFp.getResources(projectId, environmentId, contentType, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ResourcesApi extends BaseAPI {
     ...
     */
    public createResource(projectId: string, createResourceRequest?: CreateResourceRequest, options?: AxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).createResource(projectId, createResourceRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ResourcesApi
     */
    public getResource(id: string, projectId: string, environmentId: string, contentType: string, options?: AxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).getResource(id, projectId, environmentId, contentType, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ResourcesApi
     */
    public getResources(projectId: string, environmentId: string, contentType: string, options?: AxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).getResources(projectId, environmentId, contentType, options).then((request) => request(this.axios, this.basePath));
    }
}
