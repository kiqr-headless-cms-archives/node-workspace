...
export const ResourcesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getResources: async (projectId: string, environmentId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ResourcesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getResources(projectId: string, environmentId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Resource>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getResources(projectId, environmentId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ResourcesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getResources(projectId: string, environmentId?: string, options?: any): AxiosPromise<Array<Resource>> {
            return localVarFp.getResources(projectId, environmentId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ResourcesApi extends BaseAPI {
     ...
     */
    public getResources(projectId: string, environmentId?: string, options?: AxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).getResources(projectId, environmentId, options).then((request) => request(this.axios, this.basePath));
    }
}
