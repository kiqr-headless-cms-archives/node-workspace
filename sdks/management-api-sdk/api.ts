...
export const ResourcesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getResource: async (id: string, environmentId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const ResourcesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getResource(id: string, environmentId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Resource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getResource(id, environmentId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getResources(environmentId: string, page?: number, contentType?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Resource>>> {
...
export const ResourcesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getResource(id: string, environmentId: string, options?: any): AxiosPromise<Resource> {
            return localVarFp.getResource(id, environmentId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List resources for an environment
         ...
         * @throws {RequiredError}
         */
        getResources(environmentId: string, page?: number, contentType?: string, options?: any): AxiosPromise<Array<Resource>> {
...
export class ResourcesApi extends BaseAPI {
     ...
     * @memberof ResourcesApi
     */
    public getResource(id: string, environmentId: string, options?: AxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).getResource(id, environmentId, options).then((request) => request(this.axios, this.basePath));
    }
