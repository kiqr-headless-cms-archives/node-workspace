...
exports.useProjects = exports.getProjects = void 0;
var react_1 = require("react");
var kiqr_context_1 = require("../kiqr-context");
var management_api_sdk_1 = require("@kiqr/management-api-sdk");
var swr_1 = __importDefault(require("swr"));
var getProjects = function (accessToken) { return __awaiter(void 0, void 0, void 0, function () {
...
var useProjects = function () {
    ...
    var _a = (0, swr_1.default)([token === null || token === void 0 ? void 0 : token.access_token, '/projects'], exports.getProjects), projects = _a.data, projectsError = _a.error;
    return { projects: projects, projectsError: projectsError, token: token };
};
